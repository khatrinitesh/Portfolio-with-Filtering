...
(function(d) {
        ...
        if (p.length) {
            ...
            setTimeout(function() {
                if (a.resizeContainer) { for (var b = {}, c = 0; 2 > c; c++) { var e = 0 == c ? e = a.prefix : "";
                        ...
                        b.height = a.newHeight + "px" } n.css(b) } u.css("opacity", a.fade);
                q.css("opacity", 1);
                q.each(function() {
                    var b = this.data;
                    ...
                    for (var c = {}, e = 0; 2 > e; e++) { var h = 0 == e ? h = a.prefix : "";
                        ...
                        c[h + "filter"] = "none" } d(this).css("-webkit-transition", "all " + k + "ms " + a.easingFallback).css(c)
                });
                m.each(function() {
                    var b = this.data;
                    ...
                    for (var c = {}, e = 0; 2 > e; e++) { var h = 0 == e ? h = a.prefix : "";
                        ...
                        c[h + "transform"] = "translate(" + b.tX + "px," + b.tY + "px)" } d(this).css("-webkit-transition", "all " + k + "ms " + a.easingFallback).css(c)
                });
                b = {};
            ...
            setTimeout(function() {
                ...
                if (a.resizeContainer) { for (var c = {}, e = 0; 2 > e; e++) { var d = 0 == e ? d = a.prefix : "";
                        ...
                        c.height = a.minHeight + "px" } n.css(c) } v.css(a.transition);
                if (s.length) {
                    c = {};
    ...
    function x(e, c, l, b) {
        ...
        function g(a) { a = a.slice(); for (var b = a.length, c = b; c--;) { var e = parseInt(Math.random() * b),
                    d = a[c];
                a[c] = a[e];
                a[e] = d } return a } l.find(b.targetSelector).wrapAll('<div class="mix_sorter"/>');
        ...
        if ("reset" == e) d.each(b.startOrder, function() { k.append(this).append(" ") });
            ...
            d.each(b.newOrder, function() { f(this) }) } b.checkSort = [];
    ...
    function A(e, c) { if (e.length != c.length) return !1; for (var d = 0; d < c.length; d++)
            if (e[d].compare && !e[d].compare(c[d]) || e[d] !== c[d]) return !1; return !0 }
                ...
                d(b.filterSelector).bind(b.buttonEvent, function() {
                    if (!b.mixing) {
                        ...
                        if (!1 == b.multiFilter) d(b.filterSelector).removeClass("active"), c.addClass("active"), b.filter = c.attr("data-filter"), d(b.filterSelector + '[data-filter="' + b.filter + '"]').addClass("active");
                            ...
                            c.hasClass("active") ? (c.removeClass("active"), b.filter = b.filter.replace(RegExp("(\\s|^)" + e), "")) : (c.addClass("active"), b.filter = b.filter + " " + e) } r(b.filter, null, null, a, b)
                    }
                })
            })
        },
